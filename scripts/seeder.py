...
# );
# --------------------------
DB_CONN_STRING = os.getenv('DB_CONN_STRING', 'postgres://postgres:postgres@127.0.0.1:5432/proddatabase')
...
S3_ENDPOINT_URL = os.getenv('AWS_ENDPOINT_URL', 'http://localhost:9000')
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID', 'minioadmin')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY', 'minioadmin')
AWS_DEFAULT_REGION = os.getenv('AWS_REGION', 'eu-east-3')
